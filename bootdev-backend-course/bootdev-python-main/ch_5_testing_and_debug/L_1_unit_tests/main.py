...
# level
# xp_to_add
# There are 100 xp per level. total_xp should convert the current level to xp, 
# then add this current xp to the xp_to_add argument and return the player's total xp. 
# For example:
...
def total_xp(level, xp_to_add):
    ...
    total_xp = level_to_xp + xp_to_add
    return total_xp
